...
final class WSD_Cache {
    ...
    public function get(string $month) { return get_transient($this->key($month)); }
    public function set(string $month, array $aggregate): bool { return set_transient($this->key($month), $aggregate, $this->is_current_month($month) ? self::CURRENT_TTL : self::HISTORICAL_TTL); }
